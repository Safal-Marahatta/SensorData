    ...
    <div className="h-full bg-gray-900 border border-gray-700 rounded-xl shadow-xl flex flex-col p-2">
      ...
      <div className="flex justify-between items-center mt-1">
        ...
        <button
          ...
          className={`relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-blue-500 ${
            showAlarms ? 'bg-blue-600' : 'bg-gray-600'
          }`}
        >
