...
const planFeatures = [
  { feature: "Online Mode", full: false, limited: true },
...
export default function AlertsAndPlansDisplay() {
  ...
  return (<>
  <Navbar/>
    <div className="container mx-auto py-10 bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 min-h-screen">
      <motion.h1
      ...
      >
        <h2 className="text-2xl font-semibold p-6 bg-gray-700 text-emerald-400">Plan Features</h2>
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-700">
                <TableHead className="font-semibold text-lg">Feature</TableHead>
                <TableHead className="font-semibold text-lg text-center">Full</TableHead>
                <TableHead className="font-semibold text-lg text-center">Limited</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {planFeatures.map((feature, index) => (
                <TableRow key={index} className="hover:bg-gray-700/50 transition-colors duration-200">
                  <TableCell className="font-medium text-emerald-300">{feature.feature}</TableCell>
            ...
            <TableBody>
              {mockAlerts.map((alert) => (
                <TableRow key={alert.id} className="hover:bg-gray-700/50 transition-colors duration-200">
                  <TableCell className="font-medium text-blue-300">{alert.name}</TableCell>
